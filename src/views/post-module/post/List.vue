          ...
          <tr v-for="(item, index) in items" :key="index" class="intro-x">
            ...
            <td>
              <div style="text-align: center">
                <span style="display: inline-block">{{item.category ? item.category.title : ""}}</span>
                <span style="display: inline-block">{{item.post_category_id}}</span>
              </div>
            </td>
            ...
            <td class="table-report__action w-56">
              <div class="flex justify-center items-center">
                ...
                <a @click="deleteFunc(item.id)" class="flex items-center text-danger" href="javascript:;">
